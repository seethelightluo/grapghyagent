...
**CheetahClaws** réimplémente la même boucle centrale dans un Python lisible : léger, modifiable, multi-fournisseur et exécutable localement. Il conserve l’essentiel et supprime la complexité inutile. Voir ici pour plus de détails : [English version](https://github.com/SafeRL-Lab/clawspring/blob/main/docs/comparison_claude_code_vs_nano_v3.03_en.md) and [Chinese version](https://github.com/SafeRL-Lab/clawspring/blob/main/docs/comparison_claude_code_vs_nano_v3.03_cn.md)
